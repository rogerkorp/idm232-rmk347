...
<html lang="en">
    ...
    <body id="admin-body">
        ...
        while($row = mysqli_fetch_assoc($update_result)){
             ...
             echo   '<input type="text" class="longtext" id="ingredients" name="ingredients" value="' . $row['ingredients'] .'" placeholder="List of ingredients..."><br>';
             echo   '<h2>Instructions</h2>';
             echo   '<input type="text" class="longtext"  id="instructions" name="instructions" value="'.  $row['instructions'] .'" placeholder="Cooking directions..."><br>';
             echo   '<br>';
